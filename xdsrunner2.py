...
def process_xds_folder(folder_path):
    ...
    for i, xds_file in enumerate(xds_files):        
        ...
        files_to_delete = ["xds_ascii.hkl", "integrate.hkl", "correct.lp"]
    ...
    # Save excel workbook
    workbook.save(os.path.join(folder_path, "xdsrunner2.xlsx"))
    
    
    print("All information extracted after adding cell information. Note that resolution is ideal.")
    
if __name__ == "__main__":
    if len(sys.argv) > 1:
        folder_path = sys.argv[1]
        print(f"xdsrunner2 has received input path: {folder_path}")
